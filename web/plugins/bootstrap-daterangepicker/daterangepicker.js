    ...
    DateRangePicker.prototype = {
        ...
        updateMonthsInView: function() {
            if (this.endDate) {
                ...
                if (this.leftCalendar.month.format('YYYY-MM-DD') !== this.startDate.format('YYYY-MM-DD') && this.rightCalendar.month.format('YYYY-MM-DD') !== this.startDate.format('YYYY-MM-DD')) {
                    this.leftCalendar.month = this.startDate.clone().date(2);
                    this.rightCalendar.month = this.startDate.clone().date(2).add(1, 'month');
                }
            }
